...
export const metadata: Metadata = {
  title: "Basketball Hub - Premium Basketball Gear & Equipment",
  description: "Shop quality basketballs, shoes, apparel, and training equipment. Professional-grade gear for all skill levels.",
  keywords: "basketball, basketball shoes, basketball equipment, sports gear, athletic apparel",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Basketball Hub - Premium Basketball Gear",
    description: "Shop quality basketballs, shoes, and equipment for all players.",
    type: "website",
    siteName: "Basketball Hub"
  }
};
